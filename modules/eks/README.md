...
managed node groups, managed addons, cluster access/encryption config, and node
ingress security group rules. Keep those flags enabled for real AWS environments.
